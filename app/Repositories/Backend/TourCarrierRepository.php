 ...
 */
class TourCarrierRepository extends BaseRepository 
{
    /**
     ...
     * @param  User  $model
     */
    public function __construct(TourCarrier $model)
    {
        $this->model = $model;
    }
     ...
     * @return User
     */
    public function update(TourCarrier $tourcarrier, array $data,$graphic_content) : TourCarrier
    {
        return DB::transaction(function () use ($tourcarrier, $data,$graphic_content) {
            $data['graphic_content']=$graphic_content;
