...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function () {
        ...
        // User CRUD
        Route::get('user/{type?}/{invitation?}', [UserController::class, 'index'])->name('user.index');
        ...
        Route::get('user/show/{id}', [UserController::class, 'show'])->name('user.show');
         ...
         Route::get('user/tabs/first', [UserController::class, 'first'])->name('user.first');
        ...
        Route::group(['prefix' => 'user/{user}'], function () {
            ...
            Route::post('active-invitation', [UserController::class, 'requestInvitation'])->name('user.active-invitation');
            Route::post('invitation-interval', [UserController::class, 'invitationInterval'])->name('user.invitation-interval');
            Route::post('update-trial-date', [UserController::class, 'updateTrialDate'])->name('user.update-trial-date');
...
Route::get('user/show-user-profile/{id}', [UserController::class, 'showUserProfile'])->name('user.show.profile');
Route::get('user/edit-user-profile/{id}', [UserController::class, 'editUserProfile'])->name('user.edit.profile');