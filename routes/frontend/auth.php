       ...
       //These routes can not be hit if the password is expired
        Route::group(['middleware' => 'password_expires'], function () {
           //Change Password Routes
            ...
            Route::get('password/update', [UpdatePasswordController::class, 'change_pwd'])->name('change-password.update');
        });
...
Route::group(['middleware' => 'guest'], function () {
    ...
    Route::get('login/type/{role_id}', [LoginController::class, 'showLoginFormwithtype'])->name('login_role');

    Route::get('main-login', [LoginController::class, 'main_login'])->name('main_login');
    ...
    //Registration Routes
    Route::get('main-register', [RegisterController::class, 'main_register'])->name('main-register');
    ...
    Route::post('password/getemail', [ForgotPasswordController::class, 'getpasswordresetdata'])->name('password.getemail');
    //code edit by durgesh
