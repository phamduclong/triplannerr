...
<div class="row">
    <div class="col">
       <div class="form-group travel-info">
        <h4>Travel Blogger: Role, Functionality and Rules</h4>
      ...
      <div class="col">
        <div class="form-group">
             <!-- {{ html()->label(__('validation.attributes.frontend.term_condition'))->for('term_condition') }}
              {{ html()->checkbox('userdetail.term_condition')
                     ->class('form-control')
...
<div class="row">
  <div class="col-lg-4 col-md-6">
    <div class="form-group">
      ...
      <input class="form-control to_crop" type="file" name="profile" id="profile" accept="image/*" autofocus="" data-id="userdetail_profile_image" data-height="250" data-width="200" data-container="profile_image_container" data-dimension="profile">
