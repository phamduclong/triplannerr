    ...
    <div class="col">
        <div class="form-group senti-list">
            ...
            @foreach($travel_category as $category)
                <div class="input-sec">
                 <input type="checkbox" name="preferred_travel_category[]" placeholder="validation.attributes.frontend.preferred_travel_category" value="{{$category}}" id="preferred_travel_category" @if($user_data->userdetail) @if(in_array($category,$explode_preferred_travel_category)) checked="" @endif @endif>{{$category}}
                 </div>
            @endforeach
         </div><!--form-group-->
      </div><!--col-->
