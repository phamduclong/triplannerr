     		 	...
     		 	<div class="col-md-9 right-detail">
			        <div class="profile-banner">
				        ...
				        {{-- <img src="{{url('img/frontend/profile-banner.jpg')}}">
					     <p>"Start uploading your Travel Reports to mark the countries you have visited on Blue; activate the Alerts on the countries you want to visit to color the countries in red."
					    </p> --}}
			        </div>
      			</div>
   			</div>
