     ...
     <tbody>
      @foreach($report_data as $travel_report)
        <tr >
           ...
           <!--  <td>000</td>
            <td>000</td> -->
            <td class="btn-td">@include('frontend.travelblogger.control_panel.action')</td>
        </tr>
        @endforeach
    ...
    <div class="col-md-12">
        <table class="table table-striped table-bordered dt-responsive nowrap">
            ...
            <tbody>
              ...
              <tr>
                <th scope="row" style="width: 40%;text-align: left">
                    <div style="font-weight: bold;margin-top:-30px">Triplannerr “Travel Blogger” News</div>
                    <div style="margin-top:-30px">News and updates for "Travel Blogger" profiles in Triplannerr</div>
                    <div style="margin-top:-30px;text-align:center"><a href="https://t.me/+8WxuDV2-daw3YzA8"><i id="shareTelegram" class="fa fa-telegram" aria-hidden="true" style="font-size: 3.25em;color:#1E90FF"></i></a></div>
                </th>
                <td style="width: 30%;text-align: left">
              ...
              <tr>
                <th scope="row" style="width: 40%;text-align: left">
                    ...
                    <div style="font-weight: bold;margin-top:-30px">Triplannerr "Travel Blogger" Group</div>
                    <div style="margin-top:-30px">Chat reserved for "Travel Blogger" profiles in Triplannerr</div>
                    <div style="margin-top:-30px;text-align:center"><a href="https://t.me/+EYtlRziNTm1lNTlk"><i id="shareTelegram" class="fa fa-telegram" aria-hidden="true" style="font-size: 3.25em;color:#1E90FF"></i></a></div>
                </th>
                <td></td>
                <td style="width: 30%;text-align: left">
                    <div>Tik Tok</div>
