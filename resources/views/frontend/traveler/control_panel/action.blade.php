<div class="btn-group" role="group" aria-label="@lang('labels.backend.access.advertisements.user_actions')">
    ...
    <a href="{{url('delete/travel_report/'.$travel_report->slug)}}" data-toggle="tooltip" name="confirm_item" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="@lang('buttons.general.crud.delete')" onclick="return myFunction();">
