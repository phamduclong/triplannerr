...
<div class="control-table mx-50" id="controlPannelBody">
    <div class="container-fluid">
        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%;">
                        ...
                        @csrf
                          ...
                          <div class="nav">
                              <ul class="nav__list">
                                ...
                                <li class="nav__menu search_table">
                                    <a id="age_a" href="javascript:void(0)" ><?php echo (!empty($parameters['age']) && !empty($travel_ages[$parameters['age']])) ? $travel_ages[$parameters['age']] : 'Age' ?></a>
                                ...
                                <li class="nav__menu search_table">
                                    <a id="preferred_travel_mealtype_a" href="javascript:void(0)" ><?php echo (isset($parameters['travel_favoritemealtype']) && !empty($travel_budget[$parameters['travel_favoritemealtype']])) ? $travel_budget[$parameters['travel_favoritemealtype']] : 'Type of favorite Meals' ?></a>
            ...
            <tbody class="reportdata">
              @foreach($report_data as $travel_report)
                <tr>
                    <td>
                       <a href="{{url('view/travel_report/'.$travel_report->slug)}}" target="_blank" style="color: #007bff; font-size: 15px;">
                            {{$travel_report->title}}
                           </a>
            ...
            <!-- @if(!empty($report_type) && $report_type=='report')
                 <tbody class="reportdata">
                   ...
                   <tr>
                      <td>
                        <a href="#">{{$onlyreport->title}}</a>
                      </td>
                       <td>{{$onlyreport->supers_count}}</td>
                      <td>{{$onlyreport->alerts_count}}</td>
                      <td>
                        {{$onlyreport->sametrip_count}}
                        <a href="{{url('/same-trip')}}">Trip Page</a>
                      </td>
                      <td>000</td>
                      <td>000</td>
                      <td>000</td>
            ...
            <!-- @if(!empty($report_type) && $report_type=='diary')
                 <tbody class="reportdata">
                   ...
                   @endforeach
            @endif -->
            @if(!empty($report_type) && $report_type=='sametrip')
            <tbody class="reportdata">
            @endif
              {{--
              <tr>
        ...
        <div class="col-md-12">
            <table class="table table-striped table-bordered dt-responsive nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    <th scope="row" style="width: 40%;text-align: left">
                        <div style="font-weight: bold;margin-top:-30px">Triplannerr "Traveler" News</div>
                        <div style="margin-top:-30px">News and updates for "Traveler" profiles in Triplannerr</div>
                        <div style="margin-top:-30px;text-align:center"><a href="https://t.me/+qzTedh2KvKc4NDJk"><i id="shareTelegram" class="fa fa-telegram" aria-hidden="true" style="font-size: 3.25em;color:#1E90FF"></i></a></div>
                    </th>
                    <td style="width: 30%;text-align: left">
                  ...
                  <tr>
                    <th scope="row" style="width: 40%;text-align: left">
                        ...
                        <div style="font-weight: bold;margin-top:-30px">Triplannerr "Traveler" Group</div>
                        <div style="margin-top:-30px">Chat reserved for "Traveler" profiles in Triplannerr</div>
                        <div style="margin-top:-30px;text-align:center"><a href="https://t.me/+ZSA_GV7vL6QyMjRk"><i id="shareTelegram" class="fa fa-telegram" aria-hidden="true" style="font-size: 3.25em;color:#1E90FF"></i></a></div>
                    </th>
                    <td></td>
                    <td style="width: 30%;text-align: left">
                        <div>Tik Tok</div>
...
{{-- <script src="{{url('js/frontend/bootstrap.min.js')}}"></script> --}}
