        ...
        <form id="booking_form" class="booking_form" method="post" action="{{ Route('frontend.filterreport')}}">
            ...
            <div class="nav">
                <ul class="nav__list">
                    ...
                    <li class="nav__menu">
                        <a id="vector_type_a" href="javascript:void(0)" ><?php echo (isset($parameters['vector_type']) && !empty($travel_vectors[$parameters['vector_type']])) ? $travel_vectors[$parameters['vector_type']] : 'Vector Type' ?></a>
                    ...
                    <li class="nav__menu">
                        <a id="preferred_travel_mealtype_a" href="javascript:void(0)" ><?php echo (isset($parameters['travel_favoritemealtype']) && !empty($travel_mealtype[$parameters['travel_favoritemealtype']])) ? $travel_mealtype[$parameters['travel_favoritemealtype']] : 'Type of favorite Meals' ?></a>
                        <select id="preferred_travel_mealtype" name="preferred_travel_mealtype" onChange = 'load_data(this)' class="form-control tags box-size home-select">
                            <option value="">Select Favorite Meal Type</option>
                            @if(@$travel_mealtype)
            ...
            <div class="row" style="margin-top: 30px">
                {{-- <div class="form-group mx-auto"> --}}
                    ...
                    <div class="col-md-2" style="padding-left:50px;">
                        <div id="filter_only_travel_report" class="btn" style="background-color: #0198cd;text-transform: uppercase;color: #fff;font-size: 10px;font-weight:bold;height:40px;box-shadow: 1px 1px 4px 4px gray;line-height: 25px;">Travel Report</div>
                    </div>
                    <div class="col-md-2" style="float:left;">
                        <div id="filter_only_travel_buddy_search" class="btn" style="background-color: #0198cd;text-transform: uppercase;color: #fff;font-size: 10px;font-weight:bold;height:40px;box-shadow: 1px 1px 4px 4px gray;line-height: 25px;">Travel Buddy Search</div>
                    </div>
                    <div class="col-2 btn_srch form_srch" style="float:left;">
                        <button type="button" name="filter_report_btn" class="btn search_btn form_btn filter_report_btn" id="filter_report_btn">Search</button>
                    </div>
                    <div class="col-2 btn_srch form_srch"  style="float:left;">   
                        <button type="button" class="btn search_btn form_btn filter_report_btn" style="float:left;" id="reset_btn">Reset</button>
                    ...
                    <div class="col-md-2" style="float:left;">
                        <div id="filter_only_travel_post" class="btn" style="background-color: #0198cd;text-transform: uppercase;color: #fff;font-size: 10px;font-weight:bold;height:40px;box-shadow: 1px 1px 4px 4px gray;line-height: 25px;">Travel Post</div>
                    </div>
                    <div class="col-md-2" style="float:left;">
                        <div id="filter_only_travel_offert" class="btn" style="background-color: #0198cd;text-transform: uppercase;color: #fff;font-size: 10px;font-weight:bold;height:40px;box-shadow: 1px 1px 4px 4px gray;line-height: 25px;">Travel Offert</div>
                    </div>
                {{-- </div> --}}
            </div>
...
if(window.location.pathname == '/'){
    $('#filter_only_travel_report').hide();
    $('#filter_only_travel_buddy_search').hide();
    $('#filter_only_travel_post').hide();
    $('#filter_only_travel_offert').hide();
}else{
    $('#filter_only_travel_report').show();
    $('#filter_only_travel_buddy_search').show();
    $('#filter_only_travel_post').show();
    $('#filter_only_travel_offert').show();
}
$(document).ready(function(){
    $('#filter_only_travel_report').click(function(){
        sessionStorage.setItem("typeTravelReport",'travel_report');
    ...
    $('#filter_only_travel_buddy_search').click(function(){
        ...
        var preferred_travel_budget = $('#preferred_travel_budget').val();
        var preferred_travel_mealtype = $('#preferred_travel_mealtype').val();
        var querystring = "{{ url('/search-reports') }}?type_of_travel_report=travel_buddy_search"+"&country="+country+"&age="+age+"&travel_categ="+travel_categ+"&travel_type="+travel_type+"&vector_type="+vector_type+"&type_of_participants="+type_of_participants+"&type_of_accommodation="+type_of_accommodation+"&preferred_type_formula="+preferred_type_formula+"&preferred_travel_budget="+preferred_travel_budget+"&preferred_travel_mealtype="+preferred_travel_mealtype;
        window.location = querystring;
    });

    $('#filter_only_travel_post').click(function(){
        sessionStorage.setItem("typeTravelReport",'travel_post');
        var country = $('#country').val();
        var age = $('#age').val();
        var travel_categ = $('#travel_categ').val();
        var travel_type = $('#travel_type').val();
        ...
        var preferred_travel_budget = $('#preferred_travel_budget').val();
        var preferred_travel_mealtype = $('#preferred_travel_mealtype').val();
        var querystring = "{{ url('/search-reports') }}?type_of_travel_report=travel_post"+"&country="+country+"&age="+age+"&travel_categ="+travel_categ+"&travel_type="+travel_type+"&vector_type="+vector_type+"&type_of_participants="+type_of_participants+"&type_of_accommodation="+type_of_accommodation+"&preferred_type_formula="+preferred_type_formula+"&preferred_travel_budget="+preferred_travel_budget+"&preferred_travel_mealtype="+preferred_travel_mealtype;
        window.location = querystring;
    });

    $('#filter_only_travel_offert').click(function(){
        sessionStorage.setItem("typeTravelReport",'travel_offert');
        var country = $('#country').val();
        var age = $('#age').val();
        var travel_categ = $('#travel_categ').val();
        var travel_type = $('#travel_type').val();
        ...
        var preferred_travel_budget = $('#preferred_travel_budget').val();
        var preferred_travel_mealtype = $('#preferred_travel_mealtype').val();
        var querystring = "{{ url('/search-reports') }}?type_of_travel_report=travel_offert"+"&country="+country+"&age="+age+"&travel_categ="+travel_categ+"&travel_type="+travel_type+"&vector_type="+vector_type+"&type_of_participants="+type_of_participants+"&type_of_accommodation="+type_of_accommodation+"&preferred_type_formula="+preferred_type_formula+"&preferred_travel_budget="+preferred_travel_budget+"&preferred_travel_mealtype="+preferred_travel_mealtype;
        window.location = querystring;
    });
});
$(".filter_report_btn").on('click', function(){
    //alert(querystring);
    sessionStorage.setItem("typeTravelReport",'none');
    var country = $('#country').val();
    var age = $('#age').val();
    var travel_categ = $('#travel_categ').val();
    var travel_type = $('#travel_type').val();
...
$(".filter_report_btn_more").on('click', function(){
    page++;
    $('#textMoreReport').hide();
    $('#loadingReport').show();
    //alert(querystring);
    ...
    var typeTravelReport = sessionStorage.getItem("typeTravelReport");
    // if(typeTravelReport == 'none'){
    //     var querystring = "{{ url('/search-reports') }}?country="+country+"&age="+age+"&travel_categ="+travel_categ+"&travel_type="+travel_type+"&vector_type="+vector_type+"&type_of_participants="+type_of_participants+"&type_of_accommodation="+type_of_accommodation+"&preferred_type_formula="+preferred_type_formula+"&preferred_travel_budget="+preferred_travel_budget+"&preferred_travel_mealtype="+preferred_travel_mealtype;
    // }else{
    //     var querystring = "{{ url('/search-reports') }}?type_of_travel_report="+typeTravelReport+"&country="+country+"&age="+age+"&travel_categ="+travel_categ+"&travel_type="+travel_type+"&vector_type="+vector_type+"&type_of_participants="+type_of_participants+"&type_of_accommodation="+type_of_accommodation+"&preferred_type_formula="+preferred_type_formula+"&preferred_travel_budget="+preferred_travel_budget+"&preferred_travel_mealtype="+preferred_travel_mealtype;
    // }
    ...
    $.ajax({
        data:{
            page:page,
            type_of_travel_report:typeTravelReport,
            country:country,
            age:age,
            travel_categ:travel_categ,
            travel_type:travel_type,
            vector_type:vector_type,
            type_of_participants:type_of_participants,
            type_of_accommodation:type_of_accommodation,
            preferred_type_formula:preferred_type_formula,
            preferred_travel_budget:preferred_travel_budget,
            preferred_travel_mealtype:preferred_travel_mealtype,
             '_token' : '{{ csrf_token()}}'
        },
        type:'get',
        url:'{{url("/home/show-more-reports") }}',
        success: function(data){
            $('#more-travel-reports').html(data);
            $('#textMoreReport').show();
            $('#loadingReport').hide();
        },
    });
