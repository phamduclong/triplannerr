...
<?php  //echo "<pre>";print_r(explode(',',$user_data->userdetail->preferred_travel_category));?>
@php $preferred_travel_category_arr=[];
if(isset($user_data->userdetail->preferred_travel_category))
	$preferred_travel_category_arr = explode(',',$user_data->userdetail->preferred_travel_category);
@endphp
<div class="row">
    <div class="col">
        <div class="form-group senti-list">
            ...
            @foreach($travel_category as $category)
                <div class="input-sec">
                 	<input type="checkbox" name="preferred_travel_category[]" placeholder="validation.attributes.frontend.preferred_travel_category" value="{{$category}}" @if($user_data->userdetail) @if(in_array($category,$preferred_travel_category_arr)) checked=""  @endif  @endif>{{$category}}
             	</div>
            @endforeach
     	</div>
  	</div>
