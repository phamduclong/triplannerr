...
<div class="row">
    ...
    <div class="tab-content">
        <div class="tab-pane container active" id="first_step">
            @include('frontend.travelmaker.account.tabs.first_step')
        </div>
        <div class="tab-pane container fade" id="second_step">
            @include('frontend.travelmaker.account.tabs.second_step')
        </div>
        <div class="tab-pane container fade" id="third_step">
            @include('frontend.travelmaker.account.tabs.third_step')
        </div>
    </div>
</div>
