  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      @endif
        ...
        <div class="col-md-6">
           <div class="travel_budget  container-fluid">
             <div class="table-boxx">

                <table class="table table-bordered budget-table">
                <thead>
                  <tr>
                    <th colspan="2">Travel Report Name</th>
                  </tr>
                  <tr>
                    <td>
                  ...
                  @if(!empty($travel_pro_name))
                    @foreach($travel_pro_name as $value)
                     <tr>
                      <td>
                         {{$value}}
                      </td>
        ...
        <div class="send-msg">
          <div class="form-group">
            <label>Message</label>
            <textarea class="form-control" rows="5">Lorem Ipsum dummy text...
            </textarea>
          </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
             ...
             <div class="travel_btn">
                    ...
                    @if(!empty(Auth::user()))
                       ...
                       @endphp
                      @if($same_trip_page=='1')
                        <a href="#" class="travel_action status1 disabled @if($userdata)@if($userdata->user_id==Auth::user()->id) disabled @endif @endif" data-value="same trip page" data-id="{{$report_data->id}}">Same Trip Page</a>
                      @else
                        <a href="#" class="travel_action status0  @if($userdata)@if($userdata->user_id==Auth::user()->id) @endif @endif" data-value="same trip page" data-id="{{$report_data->id}}">Same Trip Page</a>
                      @endif
                    @else
                    ...
                    @if(!empty(Auth::user()))
                        ...
                        @if($same_trip=='1')
                             ...
                             @if($userdata)@if($userdata->user_id==Auth::user()->id) disabled @endif @endif" data-value="same trip" data-id="{{$report_data->id}}"onClick="same_trip_delete(this)">Same Trip</a>
