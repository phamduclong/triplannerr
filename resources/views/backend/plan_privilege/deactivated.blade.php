            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        {{ __('labels.backend.access.plan_privilege.management') }} <small class="text-muted">{{ __('labels.backend.access.plan_privilege.deactivated') }}</small>
                    </h4>
                </div><!--col-->
                        ...
                        @foreach($plan_privilege as $user)
                            <tr>
                                ...
                                <td><?php if($user->status==0){ ?>
                                      ...
                                      <?php } ?></td>
                                <td class="btn-td">@include('backend.plan_privilege.includes.actions', ['user' => $user])</td>
                            </tr>
                           <?php $i++ ?>
                        @endforeach
                        </tbody>
