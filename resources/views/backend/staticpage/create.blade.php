...
@section('title', app_name() . ' | ' . __('labels.backend.access.staticpage.create-page'))
...
@section('content')
{{ html()->form('POST', route('admin.staticpage.store'))->class('form-horizontal')->open() }}
<div class="card">
  ...
  <div class="row">
    <div class="col-sm-5">
        <h4 class="card-title mb-0">
            ...
            <small class="text-muted"> @lang('labels.backend.access.staticpage.create-page')</small>
        </h4>
    </div><!--col-->
</div><!--row-->
