...
@section('content')
{{ html()->modelForm($role, 'PATCH', route('admin.auth.role.update', $role->id))->class('form-horizontal')->attribute('enctype','multipart/form-data')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div class="col">
                        <div class="form-group row">
                            {{ html()->label(__('validation.attributes.backend.access.plan_feature.feature_name'))->class('col-md-2 form-control-label')->for('traveler_image') }}
