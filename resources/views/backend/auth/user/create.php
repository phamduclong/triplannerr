...
@section('content')
    {{ html()->form('POST', route('admin.auth.user.store'))->class('form-horizontal')->attribute('enctype','multipart/form-data')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
        ...
        $('#roleId').html('');
         function laod_role_container(obj){
            ...
            if(content_value == 'travel_agency'){
                $('#roleId').html('<label class="col-md-2 form-control-label" for="content">Travel Agency</label><div class="col-md-10"><input type="radio" name="content" id="content" value="day_trip"> Day Trip  <input type="radio" name="content" id="content" value = "standerd"> Standerd </div>');
            }
