    ...
    <div class="btn-group" role="group" aria-label="Button group">
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="breadcrumb-dropdown-1">
                ...
                <a class="dropdown-item" href="{{ route('admin.auth.user.index', ['invitation' => 'accept']) }}">Activated Invitation</a>
                <a class="dropdown-item" href="{{ route('admin.auth.user.index', ['invitation' => 'notAccept']) }}">Disabled Invitation</a>
                <a class="dropdown-item" href="{{ route('admin.auth.user.index', ['invitation' => 'pending']) }}">Requested Invitation</a>
            </div>
        </div><!--dropdown-->
