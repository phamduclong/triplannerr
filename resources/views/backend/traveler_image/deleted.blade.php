            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        {{ __('labels.backend.access.plan_feature.management') }} <small class="text-muted">{{ __('labels.backend.access.plan_feature.deleted') }}</small>
                    </h4>
                </div><!--col-->
                        ...
                        @foreach($plan_feature as $user)
                            <tr>
                                ...
                                <td><?php if($user->status==0){ ?>
                                      ...
                                      <?php } ?></td>
                                <td class="btn-td"> <a href="{{ route('admin.plan_feature.restore',$user) }}" name="confirm_item" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="@lang('buttons.backend.access.plan_feature.restore_user')"  data-trans-title="@lang('buttons.backend.access.plan_feature.are_you_sure_you_want_to_do_this')" data-trans-button-cancel="@lang('buttons.backend.access.plan_feature.cancel')" data-trans-button-confirm="@lang('buttons.backend.access.plan_feature.confirm')">
