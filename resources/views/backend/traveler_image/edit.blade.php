...
@section('title', __('labels.backend.access.plan_feature.management') . ' | ' . __('labels.backend.access.plan_feature.edit'))
...
@section('content')
{{ html()->modelForm($data, 'PATCH', route('admin.plan_feature.update', $data->id))->class('form-horizontal')->attribute('enctype','multipart/form-data')->open() }}
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.access.plan_feature.edit')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
