...
@section('content')
    {{ html()->form('POST', route('admin.advertisements.store'))->class('form-horizontal')->attribute('enctype','multipart/form-data')->open() }}
   ...
   <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
         ...
         function laod_advertisement(obj){
            ...
            if(content_value == 'Text'){
               ...
               $('#carriers_value_show').html('<label class="col-md-2 form-control-label" for="file_name">Embedded URL</label><div class="col-md-10"><input type="text" name="embedded_link" class="form-control" value=""></div>');
                ...
                $('#carriers_value_show').html('<label class="col-md-2 form-control-label" for="file_name">Graphic Video</label><div class="col-md-10" id="cover_video_container"><input type="file" name="type_file" value="" id="inp-video"></div>');
            }
            else{
                $('#tour_carriers_file').html('');
    ...
    $(document).on('change','.to_crop', function(){
        ...
        if ((file = this.files[0])) {
              ...
              $('.prev-img').remove();
              $('#cover_image_container').append('<img class="prev-img" src="'+img.src+'" alt="image" width="200" height="auto">');
          }
      }); 
</script>
