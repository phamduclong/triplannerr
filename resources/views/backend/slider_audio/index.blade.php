			...
			<div class="row">
				<div class="col-sm-5">
					<h4 class="card-title mb-0">
						{{ __('labels.backend.access.slider_audio.management') }} <small class="text-muted">{{ __('labels.backend.access.slider_audio.active') }}</small>
					</h4>
				</div><!--col-->
                        ...
                        <?php $i=1 ?>
                           @foreach($audiodata as $audio)
                              <tr>
                                ...
                                <td class="btn-td">@include('backend.slider_audio.includes.actions', ['title' => $audio])</td>
                               </tr>
                              <?php $i++ ?> 
                            @endforeach
                        </tbody>
