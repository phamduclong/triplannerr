            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        {{ __('labels.backend.access.feedback.management') }} <small class="text-muted">{{ __('labels.backend.access.feedback.deleted') }}</small>
                    </h4>
                </div><!--col-->
                        ...
                        @foreach($feedback as $user)
                            <tr>
                                ...
                                <td><?php if($user->status==0){ ?>
                                      ...
                                      <?php } ?></td>
                                <td class="btn-td"> <a href="{{ route('admin.feedback.restore',$user) }}" name="confirm_item" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="@lang('buttons.backend.access.feedback.restore_user')"  data-trans-title="@lang('buttons.backend.access.feedback.are_you_sure_you_want_to_do_this')" data-trans-button-cancel="@lang('buttons.backend.access.feedback.cancel')" data-trans-button-confirm="@lang('buttons.backend.access.feedback.confirm')">
