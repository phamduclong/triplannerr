...
@section('title', __('labels.backend.access.feedback.management') . ' | ' . __('labels.backend.access.feedback.edit'))
...
@section('content')
{{ html()->modelForm($data, 'PATCH', route('admin.feedback.update', $data->id))->class('form-horizontal')->attribute('enctype','multipart/form-data')->open() }}
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <div class="card">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.access.feedback.edit')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col">
                    {{ form_cancel(route('admin.feedback'), __('buttons.general.cancel')) }}
                </div><!--col-->
